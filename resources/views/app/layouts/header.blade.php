            ...
            <div class="row wrapper-header align-items-center">
                ...
                <div class="col-xl-6 col-md-4 col-6">
                    <a href="{{route('home')}}" class="logo-header">
                        <img src="{{asset('front/images/logo/women-logo.svg')}}" alt="logo" class="logo">
                    </a>
                </div>
                <div class="col-xl-6 col-md-4 col-3">
                        ...
                        @forelse($headerCategories as $category)
                            <li class="menu-item">
                                <a href="{{route('category.show', ['slug' => $category?->slug])}}"
                                   class="item-link">{{$category?->name ?? ''}}</a>
                                <div class="sub-menu mega-menu">
                                    <div class="container">
                                        <div class="row-demo">
                                            ...
                                            @empty
                                                <h5 class="text-left">Ürün bulunamadı.</h5>
                                            @endforelse
                                        </div>
                                        <div class="text-center view-all-demo">
                                            <a href="#modalDemo" data-bs-toggle="modal"
                                               class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>Tüm Ürünleri Gör</span><i
