                ...
                <div class="row-demo">
                    ...
                    <div class="demo-item">
                        <a href="home-multi-brand.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-multi-brand.jpg')}}" src="{{asset('front/images/demo/home-multi-brand.jpg')}}" alt="home-multi-brand">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                    ...
                    <div class="demo-item">
                        <a href="home-02.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-02.jpg')}}" src="{{asset('front/images/demo/home-02.jpg')}}" alt="home-02">
                                <div class="demo-label">
                                    <span class="demo-hot">Hot</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-03.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-03.jpg')}}" src="{{asset('front/images/demo/home-03.jpg')}}" alt="home-03">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-04.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-04.jpg')}}" src="{{asset('front/images/demo/home-04.jpg')}}" alt="home-04">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-05.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-05.jpg')}}" src="{{asset('front/images/demo/home-05.jpg')}}" alt="home-05">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-06.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-06.jpg')}}" src="{{asset('front/images/demo/home-06.jpg')}}" alt="home-06">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item position-relative">
                        <a href="home-personalized-pod.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-personalized-pod.jpg')}}" src="{{asset('front/images/demo/home-personalized-pod.jpg')}}" alt="home-personalized-pod">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item position-relative">
                        <a href="home-pickleball.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-pickleball.png')}}" src="{{asset('front/images/demo/home-pickleball.png')}}" alt="home-pickleball">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item position-relative">
                        <a href="home-ceramic.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-ceramic.png')}}" src="{{asset('front/images/demo/home-ceramic.png')}}" alt="home-ceramic">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item position-relative">
                        <a href="home-food.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-food.png')}}" src="{{asset('front/images/demo/home-food.png')}}" alt="home-food">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item position-relative">
                        <a href="home-camp-and-hike.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-camp-and-hike.png')}}" src="{{asset('front/images/demo/home-camp-and-hike.png')}}" alt="home-camp-and-hike">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-07.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-07.jpg')}}" src="{{asset('front/images/demo/home-07.jpg')}}" alt="home-07">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-08.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-08.jpg')}}" src="{{asset('front/images/demo/home-08.jpg')}}" alt="home-08">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-skincare.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-skincare.jpg')}}" src="{{asset('front/images/demo/home-skincare.jpg')}}" alt="home-skincare">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-headphone.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-headphone.jpg')}}" src="{{asset('front/images/demo/home-headphone.jpg')}}" alt="home-headphone">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-giftcard.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-giftcard.jpg')}}" src="{{asset('front/images/demo/home-giftcard.jpg')}}" alt="home-gift-card">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-furniture.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-furniture.jpg')}}" src="{{asset('front/images/demo/home-furniture.jpg')}}" alt="home-furniture">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-furniture-02.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-furniture2.jpg')}}" src="{{asset('front/images/demo/home-furniture2.jpg')}}" alt="home-furniture-2">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-skateboard.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-skateboard.jpg')}}" src="{{asset('front/images/demo/home-skateboard.jpg')}}" alt="home-skateboard">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-stroller.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-stroller.jpg')}}" src="{{asset('front/images/demo/home-stroller.jpg')}}" alt="home-stroller">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-decor.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-decor.jpg')}}" src="{{asset('front/images/demo/home-decor.jpg')}}" alt="home-decor">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-electronic.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-electronic.jpg')}}" src="{{asset('front/images/demo/home-electronic.jpg')}}" alt="home-electronic">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-setup-gear.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-setup-gear.jpg')}}" src="{{asset('front/images/demo/home-setup-gear.jpg')}}" alt="home-setup-gear">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-dog-accessories.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-dog-accessories.jpg')}}" src="{{asset('front/images/demo/home-dog-accessories.jpg')}}" alt="home-dog-accessories">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-kitchen-wear.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-kitchen.jpg')}}" src="{{asset('front/images/demo/home-kitchen.jpg')}}" alt="home-kitchen-wear">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-phonecase.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-phonecase.jpg')}}" src="{{asset('front/images/demo/home-phonecase.jpg')}}" alt="home-phonecase">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-paddle-boards.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home_paddle_board.jpg"')}} src="{{asset('front/images/demo/home_paddle_board.jpg')}}" alt="home-paddle_board">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-glasses.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-glasses.jpg')}}" src="{{asset('front/images/demo/home-glasses.jpg')}}" alt="home-glasses">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-pod-store.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-pod-store.jpg')}}" src="{{asset('front/images/demo/home-pod-store.jpg')}}" alt="home-pod-store">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-activewear.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-activewear.jpg')}}" src="{{asset('front/images/demo/home-activewear.jpg')}}" alt="home-activewear">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-handbag.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-handbag.jpg')}}" src="{{asset('front/images/demo/home-handbag.jpg')}}" alt="home-handbag">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-tee.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-tee.jpg')}}" src="{{asset('front/images/demo/home-tee.jpg')}}" alt="home-tee">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-sock.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-socks.jpg')}}" src="{{asset('front/images/demo/home-socks.jpg')}}" alt="home-sock">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-jewerly.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-jewelry.jpg')}}" src="{{asset('front/images/demo/home-jewelry.jpg')}}" alt="home-jewelry">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-sneaker.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-sneaker.jpg')}}" src="{{asset('front/images/demo/home-sneaker.jpg')}}" alt="home-sneaker">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-accessories.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-accessories.jpg')}}" src="{{asset('front/images/demo/home-accessories.jpg')}}" alt="home-accessories">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-grocery.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-gocery.jpg')}}" src="{{asset('front/images/demo/home-gocery.jpg')}}" alt="home-grocery">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-baby.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('front/images/demo/home-baby.jpg')}}" src="{{asset('front/images/demo/home-baby.jpg')}}" alt="home-baby">
                            </div>
            ...
            <div class="wrap">
                <div class="tf-mini-cart-threshold">
                    ...
                    <div class="tf-progress-msg">
                        Ücretsiz Kargodan yararlanmak için <span class="price fw-6">75.00₺</span> ve üzeri <span class="fw-6">Alışveriş yapın</span>
                    </div>
                </div>
                                ...
                                <div class="tf-mini-cart-item">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        ...
                                        <div class="tf-mini-cart-btns">
                                            ...
                                            <div class="tf-mini-cart-remove">Kaldır</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tf-mini-cart-item">
                    ...
                    <div class="tf-mini-cart-bottom">
                        ...
                        <div class="tf-mini-cart-bottom-wrap">
                            <div class="tf-cart-totals-discounts">
                                ...
                                <div class="tf-totals-total-value fw-6">49.99₺ TRY</div>
                            </div>
                            <div class="tf-cart-tax">Vergiler ve <a href="#">kargo</a> ödeme sırasında hesaplanır</div>
                            ...
                            <div class="tf-cart-checkbox">
                                ...
                                <label for="CartDrawer-Form_agree">
                                    <a href="#" title="Terms of Service">Şartları ve koşulları</a>
                                    kabul ediyorum
                                </label>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="wrap">
                <div class="tf-product-info-item">
                    <div class="image">
                        <img src="{{asset('front/images/products/orange-1.jpg')}}" alt="">
                    </div>
                    <div class="content">
                ...
                <div class="tf-product-info-buy-button">
                    <form class="">
                        ...
                        <div class="w-100">
                            <a href="#" class="btns-full">Buy with <img src="{{asset('front/images/payments/paypal.png')}}" alt=""></a>
                ...
                <div class="tf-product-media-wrap">
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper" >
                            ...
                            <div class="swiper-slide">
                                <div class="item">
                                    <img src="{{asset('front/images/products/pink-1.jpg')}}" alt="">
                                </div>
                            </div>
                        </div>
