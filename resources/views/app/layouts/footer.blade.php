                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                        ...
                        <ul class="footer-menu-list tf-collapse-content">
                            ...
                            <li>
                                <a href="{{route('login')}}" class="footer-menu_item">Hesap</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-xl-3 col-md-6 col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                            <div class="footer-menu_item">© 2025 Ata Silver. Tüm Hakları Saklıdır.</div>
                            <div class="tf-payment">
                                <img src="{{asset('front/images/payments/visa.png')}}" alt="">
                                <img src="{{asset('front/images/payments/img-1.png')}}" alt="">
                                <img src="{{asset('front/images/payments/img-2.png')}}" alt="">
                                <img src="{{asset('front/images/payments/img-3.png')}}" alt="">
                                <img src="{{asset('front/images/payments/img-4.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
